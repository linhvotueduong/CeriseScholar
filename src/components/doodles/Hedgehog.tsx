...
export function HedgehogHero({ className = "", size = 300 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 300 300" fill="none" className={className}>
      ...
      {/* Book in left hand */}
      <rect x="60" y="188" width="40" height="30" rx="3" fill="#1a1208" stroke="#2D2D2D" strokeWidth="2.5" />
      ...
      {/* Blush cheeks */}
      <ellipse cx="138" cy="125" rx="8" ry="5" fill="#1a1208" opacity="0.25" />
      <ellipse cx="202" cy="125" rx="8" ry="5" fill="#1a1208" opacity="0.25" />
      ...
      {/* Sparkle accents */}
      <path d="M50 80 L53 73 L56 80 L63 83 L56 86 L53 93 L50 86 L43 83Z" fill="#1a1208" opacity="0.6" />
      <path d="M260 145 L262 140 L264 145 L269 147 L264 149 L262 154 L260 149 L255 147Z" fill="#1a1208" opacity="0.4" />
      <circle cx="280" cy="85" r="3" fill="#1a1208" opacity="0.3" />
    </svg>
  );
}
...
export function HedgehogReading({ className = "", size = 200 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" className={className}>
      ...
      {/* Blush */}
      <ellipse cx="85" cy="90" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />
      <ellipse cx="131" cy="90" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />
      ...
      <line x1="55" y1="163" x2="88" y2="161" stroke="#1a1208" strokeWidth="2.5" strokeLinecap="round" />
...
export function HedgehogHighlighting({ className = "", size = 200 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" className={className}>
      ...
      {/* Blush */}
      <ellipse cx="88" cy="90" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />
      <ellipse cx="136" cy="90" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />

      {/* Right arm holding highlighter */}
      <path d="M158 115 Q172 108 178 95" stroke="#2D2D2D" strokeWidth="3" fill="none" strokeLinecap="round" />

      {/* Highlighter pen */}
      <rect x="170" y="58" width="14" height="45" rx="3" fill="#1a1208" stroke="#2D2D2D" strokeWidth="2" transform="rotate(15 177 80)" />
      <rect x="172" y="48" width="10" height="14" rx="2" fill="#000000" stroke="#2D2D2D" strokeWidth="1.5" transform="rotate(15 177 55)" />
      <path d="M173 102 L177 112 L181 102" fill="#1a1208" stroke="#2D2D2D" strokeWidth="1.5" transform="rotate(15 177 107)" />
      ...
      <rect x="30" y="159" width="40" height="6" rx="1" fill="#1a1208" opacity="0.3" />
      ...
      {/* Sparkle */}
      <path d="M40 55 L42 50 L44 55 L49 57 L44 59 L42 64 L40 59 L35 57Z" fill="#1a1208" opacity="0.5" />
    </svg>
  );
}
...
export function HedgehogListening({ className = "", size = 200 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" className={className}>
      ...
      {/* Left headphone cup */}
      <rect x="58" y="65" width="18" height="24" rx="8" fill="#1a1208" stroke="#2D2D2D" strokeWidth="2.5" />
      {/* Right headphone cup */}
      <rect x="144" y="65" width="18" height="24" rx="8" fill="#1a1208" stroke="#2D2D2D" strokeWidth="2.5" />
      ...
      {/* Blush */}
      <ellipse cx="86" cy="90" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />
      <ellipse cx="134" cy="90" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />
      ...
      {/* Music notes */}
      <path d="M42 50 L42 38 L50 35 L50 47" stroke="#1a1208" strokeWidth="2" fill="none" strokeLinecap="round" />
      <circle cx="42" cy="50" r="3.5" fill="#1a1208" />
      <circle cx="50" cy="47" r="3.5" fill="#1a1208" />

      <path d="M165 42 L165 30" stroke="#1a1208" strokeWidth="2" strokeLinecap="round" />
      <circle cx="165" cy="42" r="3" fill="#1a1208" opacity="0.6" />
...
export function HedgehogWriting({ className = "", size = 200 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" className={className}>
      ...
      {/* Blush */}
      <ellipse cx="82" cy="82" rx="5" ry="3" fill="#1a1208" opacity="0.25" />
      <ellipse cx="128" cy="82" rx="5" ry="3" fill="#1a1208" opacity="0.25" />
      ...
      <line x1="37" y1="140" x2="60" y2="140" stroke="#1a1208" strokeWidth="2" strokeLinecap="round" />
      ...
      <line x1="152" y1="125" x2="158" y2="122" stroke="#1a1208" strokeWidth="3" strokeLinecap="round" />
...
export function HedgehogIdea({ className = "", size = 200 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" className={className}>
      ...
      {/* Blush */}
      <ellipse cx="86" cy="93" rx="6" ry="3.5" fill="#1a1208" opacity="0.3" />
      <ellipse cx="134" cy="93" rx="6" ry="3.5" fill="#1a1208" opacity="0.3" />
      ...
      {/* Sparkles */}
      <path d="M30 65 L32 60 L34 65 L39 67 L34 69 L32 74 L30 69 L25 67Z" fill="#1a1208" opacity="0.5" />
...
export function HedgehogSearch({ className = "", size = 200 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" className={className}>
      ...
      {/* Blush */}
      <ellipse cx="86" cy="88" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />
      <ellipse cx="134" cy="88" rx="6" ry="3.5" fill="#1a1208" opacity="0.25" />
...
export function HedgehogWaving({ className = "", size = 120 }: { className?: string; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none" className={className}>
      ...
      {/* Blush */}
      <ellipse cx="49" cy="54" rx="4" ry="2.5" fill="#1a1208" opacity="0.25" />
      <ellipse cx="79" cy="54" rx="4" ry="2.5" fill="#1a1208" opacity="0.25" />
