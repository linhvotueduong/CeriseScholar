...
export const agreementDocuments: Record<AgreementKey, AgreementDocument> = {
  terms: {
    ...
    updated: "May 13, 2026",
    intro:
      "These Terms of Use explain how to use the Cerise Scholar public laptop beta responsibly, what you keep ownership of, how the laptop-first Local Agent works, and what limits apply while the product is still growing.",
    sections: [
      {
        heading: "1. Agreement to these terms",
        body: [
          "These Terms of Use govern your access to and use of Cerise Scholar, including the website, signup and login flows, hosted research features, account features, help pages, public beta features, and any local-helper workflows made available through the Cerise Scholar Local Agent.",
          ...
          "Cerise Scholar is currently a public beta. Some features may change, be limited, be unavailable on some devices, or require a trusted laptop setup before they work fully.",
        ],
      },
      {
        ...
        body: [
          ...
          "Keep your login method, email account, device password, and trusted laptop secure. If you believe someone has accessed your account or laptop workspace without permission, stop using the affected device for Cerise Scholar and contact support.",
        ],
      },
      {
        heading: "3. Laptop-first beta and trusted devices",
        body: [
          "Cerise Scholar is designed around a laptop-first research workflow. You may be able to sign in on mobile or another device for lighter account access, reading, review, and support pages, but the full private source-file workflow belongs on the personal or trusted laptop where your files, local workspace, and local AI tools live.",
          "A trusted laptop means a device you own or control, understand, and are allowed to use for private research files. Do not install or run local-agent workflows on shared, public, borrowed, school-lab, cafe, library, or employer-controlled computers unless you have clear permission and understand the privacy risk.",
          "You are responsible for deciding whether a device is appropriate for your research files and for following any school, employer, funder, ethics-board, or data-use rules that apply to your work.",
        ],
      },
      {
        heading: "4. Cerise Scholar Local Agent",
        body: [
          "The Cerise Scholar Local Agent is a local helper intended to run on your trusted laptop. It may help create or access a local workspace, check whether local AI tools such as Ollama are available, index or prepare source-file text for approved workflows, run local AI-heavy tasks, and clean generated local data when you choose a cleanup action.",
          "The Local Agent is not a remote administrator for your computer. Cerise Scholar should not ask for broad device control, contacts, camera, microphone, location, or private accounts that are unrelated to the requested research workflow.",
          "Some setup steps, such as installing Ollama or approving a local helper, may require action from you in your operating system. Cerise Scholar may link you to official installers or setup instructions, but you are responsible for reviewing the software you install and approving only actions you trust.",
        ],
      },
      {
        heading: "5. Hosted services and third-party providers",
        body: [
          "Some Cerise Scholar features use hosted services. For example, Cerise Scholar may use Supabase for authentication, account records, and app data; OpenAlex for scholarly source discovery; and configured AI providers when a hosted or cloud fallback feature is enabled.",
      ...
      },
      {
        ...
        body: [
          ...
          "You give Cerise Scholar a limited permission to process your content only as needed to provide, secure, maintain, debug, and support the service and the features you request. For local-agent workflows, that processing may happen locally on your trusted laptop. For hosted workflows, selected data may be sent to hosted services as described in the Privacy Policy.",
      ...
      },
      {
        ...
        body: [
          ...
          "We may temporarily block or limit certain local AI workflows if the Local Agent, Ollama, a model, a security check, or your trusted-device setup is not ready. Those limits are intended to protect your account, your local files, and the beta service.",
      ...
      },
      {
        ...
        body: [
          ...
          "Local tools depend on your laptop, operating system, network, browser, Local Agent, Ollama setup, models, and permissions. Hosted tools depend on providers, APIs, infrastructure, and availability outside your direct control.",
  ...
  privacy: {
    ...
    updated: "May 13, 2026",
    intro:
      "This Privacy Policy explains what Cerise Scholar collects, what is intended to stay on your trusted laptop, how hosted services are used, and what choices you have during the public laptop beta.",
    sections: [
      {
        heading: "1. Summary",
        body: [
          "Cerise Scholar is designed as a laptop-first research workspace. The full AI-heavy source-file workflow is intended to run from a personal or trusted laptop where your local files, local workspace, local helper, and local AI tools can live.",
          "Your private source files and local-agent workspace are intended to stay on your trusted laptop unless you choose a hosted feature that sends selected information to Cerise Scholar or a configured provider. We do not sell your personal information, and we do not use your private source files, prompts, or outputs to train Cerise Scholar models.",
      ...
      {
        heading: "5. Local files and Local Agent activity",
        body: [
          "The Cerise Scholar Local Agent is intended to run locally on your trusted laptop, usually through a loopback address such as 127.0.0.1. It may help check setup status, prepare a local workspace, read or index source files, connect to local AI tools such as Ollama, and clean generated local data when you approve those workflows.",
          "Cerise Scholar is designed so private source-file processing for AI-heavy workflows can stay on your laptop. The Local Agent should not give Cerise Scholar broad remote control of your computer, and it should not require unrelated permissions such as contacts, SMS, call logs, calendar, microphone, camera, or browser location.",
          "Local privacy also depends on your own laptop security. Anyone with access to your device, operating-system account, downloads, browser profile, local workspace, or local AI tools may be able to see local files or generated data. Use the Local Agent only on a personal or trusted laptop.",
        ],
      },
      {
        ...
        body: [
          ...
          "ScholarAsk or related source-discovery features may query OpenAlex for scholarly metadata and source discovery. If cloud AI fallback or hosted AI processing is enabled, selected prompts and context may be sent to configured AI providers for inference.",
          "Where possible, Cerise Scholar is designed to keep hosted processing limited to the feature you choose. The app should not upload your full private source-file workspace to hosted services unless a feature clearly asks for uploaded content or you choose to provide it.",
        ],
      },
      {
        heading: "7. How we use information",
        body: [
          "We use information to create and authenticate accounts, operate Cerise Scholar, provide requested research and setup features, maintain the Local Agent readiness flow, save preferences, respond to support, send product communications you requested or allowed, improve reliability, debug errors, and protect the service from abuse.",
      ...
      },
      {
        ...
        body: [
          "Cerise Scholar may link to outside websites, documentation, academic sources, software installers, third-party apps, or provider pages. Those websites and services are not controlled by Cerise Scholar and may have their own privacy, security, accessibility, and data-use practices.",
      ...
      },
      {
        ...
        body: [
          ...
          "Cerise Scholar does not need your laptop password. Your operating system may ask for your password when you install or approve separate local software, but that approval happens with your operating system, not by sending your password to Cerise Scholar.",
        ],
      },
      {
        ...
        body: [
          ...
          "Local files and local-agent generated data may remain on your laptop until you delete them, use a cleanup workflow, uninstall local tools, clear local workspaces, or remove them through your operating system.",
      ...
      },
      {
        heading: "12. Security",
        body: [
          "We use reasonable technical and organizational measures intended to protect Cerise Scholar accounts and hosted systems. No internet service, browser session, laptop, local helper, model runtime, or storage system can be guaranteed perfectly secure.",
          ...
          "You can help protect your research by using a trusted laptop, keeping your operating system and browser updated, protecting your device password, signing out on shared devices, avoiding public computers for private source files, and keeping your own backups of important work.",
      ...
      },
      {
        ...
        body: [
          ...
          "You can also choose not to use hosted AI features, choose not to provide optional profile fields, opt out of optional emails where offered, use a trusted laptop for local workflows, and avoid uploading source files to hosted features unless you want that processing.",
      ...
      },
      {
        ...
        body: [
          "Your laptop workspace is meant to be local. Hosted account and app services still exist. Hosted AI or source-discovery features may process the selected information needed for the feature. Cerise Scholar does not sell your personal information. Cerise Scholar does not train its models on your private source files, prompts, or outputs.",
