  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "12px 24px 0", flexShrink: 0, position: "relative" }}>
        <img src={HEDGEHOG.hedgehog06Clasped} alt="" className="pointer-events-none hidden lg:block" style={{ position: "absolute", left: "calc(50% - 550px - 60px)", top: "8px", height: "52px", width: "auto", objectFit: "contain", zIndex: 10 }} />
