      ...
      <div className="-mx-8 -my-8 flex flex-col h-[calc(100vh-57px)]">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto">
            {messages.length === 0 ? (
              <div className="relative flex h-full flex-col items-center justify-center overflow-hidden bg-white px-6">
                <img
                  src="/assets/characters/lightbulb2_nobg.png"
                  alt=""
                  aria-hidden="true"
                  className="pointer-events-none absolute left-1/2 top-1/2 h-auto w-[min(46rem,72vw)] -translate-x-1/2 -translate-y-[54%] opacity-90"
                />
