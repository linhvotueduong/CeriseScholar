      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <Link href="/dashboard" className="text-sm text-gray-600 hover:text-[#DE3163] font-medium transition-colors">
              Workspace
            </Link>
            <Link href="/" className="text-sm text-[#DE3163] font-medium">
              Home
            </Link>
